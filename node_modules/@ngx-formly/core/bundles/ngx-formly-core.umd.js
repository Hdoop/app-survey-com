    ...
    ***************************************************************************** */
                 ...
                 */function (field) {
                    if (field.key && !field.fieldGroup) {
                        ...
                        var valueChanges = field.modelOptions.debounce && field.modelOptions.debounce.default
                            ? field.formControl.valueChanges.pipe(operators.debounceTime(field.modelOptions.debounce.default))
    ...
    var FieldArrayType = /** @class */ (function (_super) {
         ...
         */
            function (field) {
                ...
                registerControl(field, new forms.FormArray(field.fieldGroup.map(( /**
                 * @param {?} f
                 * @return {?}
    ...
    var FieldWrapper = /** @class */ (function (_super) {
        ...
        FieldWrapper.propDecorators = {
            fieldComponent: [{ type: i0.ViewChild, args: ['fieldComponent', ( /** @type {?} */({ read: i0.ViewContainerRef, static: true })),] }]
        };
        return FieldWrapper;
    }(FieldType));
